...
exports.default = SeqGrammar;
function SeqGrammar(All, Any, Plus, Optional, Char, Capture) {

  // Y combinator
  var Y = function Y(gen) {
    return function (f) {
      return f(f);
    }(function (f) {
      return gen(function () {
  ...
  return Y(function (thisGrammar) {
    // define Keppel rules
    function Text(alphabet) {
      return Optional(Plus(Char(alphabet)));
    }
